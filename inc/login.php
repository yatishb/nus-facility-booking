...
<script>window.location.href = "/cs2102/inc/confirm-booking.php?bookstart=<?php echo $bookstart; ?>&bookend=<?php echo $bookend; ?>&bookfac=<?php echo $bookfac; ?>&bookreg=<?php echo $bookreg; ?>&bookdate=<?php echo $bookdate; ?>&bookuser=<?php echo $_SESSION['username']; ?>"; </script>
<?php } ?>
